export const IPC = {
  ...
  NvimPtyStart: 'nvim-pty:start',
  NvimPtyWrite: 'nvim-pty:write',
  NvimPtyResize: 'nvim-pty:resize',
  NvimPtyKill: 'nvim-pty:kill',
  NvimPtySetTheme: 'nvim-pty:setTheme',
  NvimPtyData: 'nvim-pty:data',
  NvimPtyExit: 'nvim-pty:exit',
  ...
  SessionsSetNotes: 'sessions:setNotes',
